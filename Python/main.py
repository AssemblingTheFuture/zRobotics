...
# 3. Set Denavit - Hartenberg parameters
L1 = uRobot.denavitHartenberg(d = L[0], alpha = np.pi / 2)
L2 = uRobot.denavitHartenberg(a = L[1])
L3 = uRobot.denavitHartenberg(alpha = np.pi / 2)
L4 = uRobot.denavitHartenberg(d = L[2])
